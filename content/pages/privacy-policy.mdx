...
description: Privacy policy for CSV Viewer
created_at: 2025-10-24
---

## Introduction

Welcome to CSV Viewer, a **free browser-based tool** for opening, exploring, and analyzing CSV files. At CSV Viewer, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using CSV Viewer:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use CSV Viewer, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access CSV Viewer, such as device type, operating system, and browser type.
...
**Note on CSV files**: CSV Viewer processes your uploaded CSV files entirely in your browser. Your file data is not uploaded to or stored on our servers.
...
**Copyright Owner**: [csvviewer.net](https://csvviewer.net)
**Email**: [support@csvviewer.net](mailto:support@csvviewer.net)

By using CSV Viewer, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
